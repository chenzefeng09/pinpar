...
public class MyActivityListRequest extends BaseJsonRequest{
	...
	public MyActivityListRequest(String uid,String type,String maxid,String pageNum,String pageCount,
			Listener<JSONObject> listener) {
		super(Method.GET,
				String.format("api.pinpa?protocol=%s&a=%s&b=%s&c=%s&d=%s&pageNum=%s&pageCount=%s",
						PROTOCOL,
						uid,
						type,
						MD5Util.MD5(PROTOCOL+uid+type+"pinpa"),
	...
	public MyActivityListRequest(String uid,String type,String maxid,
			Listener<JSONObject> listener) {
		super(Method.GET,
