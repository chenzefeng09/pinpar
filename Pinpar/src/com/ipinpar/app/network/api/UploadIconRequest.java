...
public class UploadIconRequest{
	private static final String PROTOCOL ="10009";
 
    private Response.Listener mListener;
    private HttpEntity mEntity;
 
    public UploadIconRequest(final int uid,final File fileBodyParamMap,final Response.Listener listener, Response.ErrorListener errorListener) {
