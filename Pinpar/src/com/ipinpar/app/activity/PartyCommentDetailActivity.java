...
public class PartyCommentDetailActivity extends PPBaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		setContentView(R.layout.activity_party_comments_list);
...
//												comment.setText(commentcount + "");
	...
	public static Intent getIntent2Me(Context context, int fromid,
			String fromidtype) {
		Intent intent = new Intent(context, PartyCommentDetailActivity.class);
