...
public class RoundCornerImageView extends ImageView {
    ...
    public RoundCornerImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundCornerImageView,
                defStyle, 0);

        mDesaturateOnPress = a.getBoolean(R.styleable.RoundCornerImageView_desaturateOnPress,
                mDesaturateOnPress);
        mCornerRadius = a.getDimension(R.styleable.RoundCornerImageView_cornerRadius, mCornerRadius);
