...
public class FlowLayout extends ViewGroup {
	...
	private int totalLineVer = 0;
	private boolean setViewGone = false;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if(setViewGone){
            ...
            if (newLine) {
            		if(totalLine > maxLine && maxLine > 0){
                     	child.setVisibility(View.GONE);
                     	setViewGone = true;
                     	break;
                     }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        private static int NO_SPACING = -1;//-1
        private int x;
        private int y;
        ...
        private void readStyleParameters(Context context, AttributeSet attributeSet) {
            ...
            try {
                horizontalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_LayoutParams_layout_horizontalSpacing, 20);
                verticalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_LayoutParams_layout_verticalSpacing, 15);
