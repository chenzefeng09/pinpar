 ...
 * @author 陈彤
 */
public class PullToRefreshWhiteHeaderListView extends ListView implements OnScrollListener {
	...
	public PullToRefreshWhiteHeaderListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.refresh_white_header,
				null);
...
//			arrowImageView.setVisibility(View.GONE);
		...
		case DONE:
			...
			arrowImageView.clearAnimation();
			arrowImageView.setImageResource(R.drawable.refresh_refresh_white);
			arrowImageView.setVisibility(View.GONE);
